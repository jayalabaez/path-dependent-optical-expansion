...
The repository now tests the surviving model classes against the physical CMB
...
The local suite passes **26/26 software tests**.  This validates the code paths,
not the physical theory.

The resulting scientific classification is:
...
See `docs/V4_COMPREHENSIVE_AUDIT.md` for assumptions, numerical bounds, and the
remaining work required before any scientific approval.
